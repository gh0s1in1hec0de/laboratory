...
import {
    ...
    PURCHASE_TX_COST_V2A,
    REFUND_TX_COST_V2A
} from "../fees";

export class TokenLaunchV2AMessageBuilder {
    /*
    * - Creator buyout
    * - Wl purchase
    * - Public purchase
    ...
    */
    ...
    public static whitelistPurchaseMessage(
        ...
        return {
            ...
            messages: [
                {
                    amount: (pureValue * 100n / 99n + PURCHASE_TX_COST_V2A).toString(),
                    address: launchAddress,
                    payload: body.toBoc().toString("base64")
                }
            ]
    ...
    public static refundMessage(
        ...
        const messages = [
            {
                amount: REFUND_TX_COST_V2A.toString(),
                address: launchAddress,
