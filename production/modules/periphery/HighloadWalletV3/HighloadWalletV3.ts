...
import { HighloadQueryIdManager } from "./HighloadQueryIdManager";
...
export class HighloadWalletV3 implements Contract {
    ...
    async getProcessed(provider: ContractProvider, queryId: HighloadQueryIdManager, needClean = true): Promise<boolean> {
