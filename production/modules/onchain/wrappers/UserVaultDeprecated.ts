...
export class UserVaultDeprecated implements Contract {
    constructor(readonly address: Address, readonly init?: { code: Cell; data: Cell }) {}

    static createFromAddress(address: Address) {
        return new UserVaultDeprecated(address);
    }
    ...
    static createFromState(state: { owner: Address, tokenLaunch: Address }, code: Cell, workchain = BASECHAIN) {
        ...
        return new UserVaultDeprecated(contractAddress(workchain, init), init);
    }
