...
async function tryLoadOpAndQueryId(messageBody: Slice): Promise<{ changedSlice: Slice, op: number, queryId: number }> {
...
function tryParseBalanceUpdate(purifiedMessageBody: Slice): BalanceUpdateMessage {
...
/// Op and query id had already been loaded
function tryParseRefundOrClaim(purifiedMessageBody: Slice): RefundOrClaimConfirmationMessage {
